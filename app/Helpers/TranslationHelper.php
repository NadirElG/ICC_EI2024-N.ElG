...
class TranslationHelper
{
    ...
    {
        // Récupérer la langue cible dans la session ou définir l'anglais par défaut
        $targetLang = $targetLang ?? session('locale', 'en');
        ...
        try {
            ...
            $tr->setSource('en'); // Définir l'anglais comme langue source
